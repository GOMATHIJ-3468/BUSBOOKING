...
public interface BusDetailRepo extends JpaRepository<BusDetails, Integer> {
	...
	@Query(value = "select * from bus_info where boardingpoint=:s and droppingpoint=:ns",nativeQuery = true)
	public List<BusDetails> getbusinfo(@Param("s") String id,@Param("ns") String bus_no);
