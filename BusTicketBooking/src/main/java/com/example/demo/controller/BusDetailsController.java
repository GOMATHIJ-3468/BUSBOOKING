...
public class BusDetailsController {
	...
	//GETSTUDENT BY ID AND NAME USING SQL
		...
		@GetMapping("showbuses/{board}/{drop}")
		public List<BusDetails> showdetails(@PathVariable String board,@PathVariable String drop){
			return bs.getbusdetinfo(board, drop);
		}
